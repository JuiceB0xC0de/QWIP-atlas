...
CREATE TABLE IF NOT EXISTS bouncer_features (
    layer_id INTEGER,
    component TEXT,
    feature_idx INTEGER,
    fstat REAL,
...
CREATE INDEX IF NOT EXISTS idx_bouncer_layer_comp ON bouncer_features(layer_id, component);
CREATE INDEX IF NOT EXISTS idx_bouncer_fstat      ON bouncer_features(fstat DESC);

CREATE TABLE IF NOT EXISTS bouncer_per_head (
    layer_id INTEGER,
    component TEXT,
    head_idx INTEGER,
    head_dim INTEGER,
